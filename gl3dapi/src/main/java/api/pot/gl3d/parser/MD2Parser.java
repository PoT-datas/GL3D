...
public class MD2Parser extends AParser implements IParser {
	...
	public MD2Parser(Resources resources, String resourceID, int resId, boolean generateMipMap) {
		super(resources, resourceID, resId, generateMipMap);
	}
	...
	@Override
	public void parse() {
		InputStream fileIn = resources.openRawResource(this.resId/*resources.getIdentifier(
